...
<div class="row">
            <div class="box">
                <div class="col-lg-12">
                    ...
                    <p>Je m'appelle Cheikhou Oumar LY, je travaille actuellement chez Vivializ sur Dakar (Sénégal) en tant que développeur web et mobile. Passionné par l'informatique et les nouvelles technologies, je m'intéresse fortement à l'entrepreunariat et aux environnements startups.</p>
